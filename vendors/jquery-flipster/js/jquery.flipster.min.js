...
!(function (I, t, P) {
  ...
  I.fn.flipster = function (e) {
    ...
    return this.each(function () {
            ...
            ? (e && (clearInterval(e), (e = !1)),
              l.each(function (t) {
                ...
                i.attr("class", function (t, e) {
                  ...
                  (e = i.outerWidth()),
                  0 !== k.spacing &&
                    i.css("margin-right", e * k.spacing + "px"),
                  (n = i.position().left),
                  (p[t] = -1 * (n + e / 2 - o / 2)),
                  t === l.length - 1 && (g(), a && setTimeout(d, 1));
              }))
            : (e =
                e ||
      ...
      function g() {
        ...
        l.each(function (t) {
          (e = I(this)),
            ...
            (i =
              t === v
                ? ((n += T.itemCurrent), a + 1)
                : t < v
                ? ((n += T.itemPast + " " + T.itemPast + "-" + (v - t)),
                  a - (v - t))
                : ((n += T.itemFuture + " " + T.itemFuture + "-" + (t - v)),
                  a - (t - v))),
          ...
          0 <= v &&
            ((o && p[v] !== P) || m(!0),
            M
              ? r.css("transform", "translateX(" + p[v] + "px)")
              : r.css({ left: p[v] + "px" })),
          (function () {
            if (k.nav) {
              var t = s.data("flip-category");
              u.removeClass(T.navCurrent),
                f
                  .filter(function () {
                    return (
                      I(this).data("index") === v ||
                      (t && I(this).data("category") === t)
                    );
                  })
                  .parent()
          ...
          return (
            "prev" === t
              ...
              : t !== P &&
                ...
                k.loop &&
                  e != v &&
                  (e == l.length - 1 && v != l.length - 2 && (v = 0),
                  0 == e && 1 != v && (v = l.length - 1))),
            (s = l.eq(v)),
            v !== e && k.onItemSwitch && k.onItemSwitch.call(i, l[v], l[e]),
            g(),
            i
          );
      }
      ...
      function w() {
        m(!0),
          i.hide().css("visibility", "").addClass(T.active).fadeIn(k.fadeIn);
      }
      function C() {
        if (
          ((r = i.find(k.itemContainer).addClass(T.container)),
          !((l = r.find(k.itemSelector)).length <= 1))
        )
          return (
            l.addClass(T.item).each(function () {
              var t = I(this);
              t.children("." + T.itemContent).length ||
                t.wrapInner('<div class="' + T.itemContent + '" />');
            }),
            k.click &&
              l.on("click.flipster touchend.flipster", function (t) {
                n ||
                  (I(this).hasClass(T.itemCurrent) || t.preventDefault(),
                  _(this));
              }),
            k.buttons &&
              1 < l.length &&
              (i.find("." + T.button).remove(), i.append(h("prev"), h("next"))),
            (function () {
              var s = {};
              !k.nav ||
                l.length <= 1 ||
                (c && c.remove(),
                (c = I('<ul class="' + T.nav + '" role="navigation" />')),
                (f = I("")),
                l.each(function (t) {
                  var e = I(this),
                    ...
                    a = I(
                      '<ahref="#contact"class="' + T.navLink + '">' + i + "</a>"
                    ).data("index", t);
                  if (((f = f.add(a)), n)) {
                    if (!s[n]) {
                      var r = I(
                        ...
                        o = I(
                          ...
                          .data("category", n)
                          .data("index", t);
                      (s[n] = I('<ul class="' + T.navChild + '" />')),
                        (f = f.add(o)),
                        r.append(o, s[n]).appendTo(c);
                    }
                    s[n].append(a);
                  } else c.append(a);
                ...
                "after" === k.nav ? i.append(c) : i.prepend(c),
                (u = c.find("." + T.navItem)));
            })(),
            0 <= v && _(v),
            i
      ...
      (t = {
        ...
        i.hasClass(T.active) ||
          (function () {
            var t;
            if ((i.css("visibility", "hidden"), C(), l.length <= 1))
              i.css("visibility", "");
            else {
              (t =
                !!k.style &&
                "flipster--" + k.style.split(" ").join(" flipster--")),
                i.addClass(
                  [
                    T.main,
                    M ? "flipster--transform" : " flipster--no-transform",
                    t,
                    k.click ? "flipster--click" : "",
                  ].join(" ")
                ),
                k.start &&
                  (v =
                    "center" === k.start ? Math.floor(l.length / 2) : k.start),
                _(v);
              var e = i.find("img");
              if (e.length) {
                var n = 0;
                  ...
                  k.keyboard &&
                    ...
                    t.on(
                      ...
                      D(function (t) {
                        var e = t.which;
                        (37 !== e && 39 !== e) ||
                          (_(37 === e ? "prev" : "next"), t.preventDefault());
                      }, 250)
                    ));
                })(i),
                (function (t) {
                      ...
                      .on(
                        ...
                        D(function (t) {
                          clearTimeout(r),
                            ...
                            (t = t.originalEvent),
                            (o += t.wheelDelta || -1 * (t.deltaY + t.deltaX)),
                            (Math.abs(o) < 25 && !s) ||
                              (a++,
                              n !== (e = 0 < o ? "prev" : "next") && (a = 0),
                              (n = e),
                              (a < 6 || a % 3 == 0) && _(e),
                              (o = 0));
                        }, 50)
                      ),
                      E.on("mousewheel.flipster wheel.flipster", function (t) {
